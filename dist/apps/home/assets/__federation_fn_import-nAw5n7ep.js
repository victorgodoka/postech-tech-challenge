...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-BPugcRLE.js', import.meta.url).href),import:true},'vue-router':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-router-CNbAfG6g.js', import.meta.url).href),import:true}};
