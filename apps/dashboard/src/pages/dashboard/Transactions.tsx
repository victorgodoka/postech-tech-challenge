...
import { AdvancedFilters, type FilterOptions } from "@/components/Transactions/AdvancedFilters";
...
const Transactions: React.FC<{ accountId: string }> = ({ accountId }) => {
  ...
  const handleAdvancedFiltersChange = useCallback((newFilters: FilterOptions) => {
    setFilters({
  ...
  // const handlePaginationChange = useCallback((_paginatedTransactions: Transaction[], currentPage: number, _totalPages: number) => {
